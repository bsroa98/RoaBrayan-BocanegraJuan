...
public class ProfesorDaoImp implements IProfesorDao {
    ...
    public String saveProfesor(Profesor newProfesor) {
        ...
        try {
            ...
            int resultado = 0;
            pstmt = cnn.prepareStatement("INSERT INTO profesor VALUES (?, ?, ?, ?)");
            pstmt.setInt(1, newProfesor.getCedulaProfesor());
            pstmt.setString(2, newProfesor.getNombreCompleto());
            pstmt.setString(3, newProfesor.getCorreoElectronico());
            pstmt.setString(4, newProfesor.getUserName());
